...
Glucose = st.sidebar.slider("Glucose (mg/dL)", 0.50, 1.50)
pO2 = st.sidebar.slider("pO2 (mmHg)", 60, 360)
pCO2 = st.sidebar.slider("pCO2 (mmHg)", 20, 80)
pH = st.sidebar.slider("pH (unit)", 7.25, 7.55)
